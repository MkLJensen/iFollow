...
module top ;
    ...
    UART_v2_50_2 UART_1 (
        ...
        .reset(Net_1785),
        .rx(Net_1786),
        .tx_interrupt(Net_1787),
        .rx_interrupt(Net_1788),
        .tx_data(Net_1789),
        .tx_clk(Net_1790),
        .rx_data(Net_1791),
        .rx_clk(Net_1792));
