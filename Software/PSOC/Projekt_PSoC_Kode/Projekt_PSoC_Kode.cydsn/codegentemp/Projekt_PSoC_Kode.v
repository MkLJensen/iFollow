...
module top ;
    ...
    SPI_Slave_v2_70_3 SPIS_1 (
        .mosi(Net_2694),
        .sclk(Net_2463),
        .ss(Net_2464),
        .miso(Net_2765),
        .clock(Net_2465),
        .tx_interrupt(Net_1801),
        .sdat(Net_1802),
        .rx_interrupt(Net_2753),
        .miso_oe(Net_1804),
        .reset(1'b0));
	...
	cy_psoc3_pins_v1_10
		#(.id("359ebc39-a156-43c4-acbb-610f09780850"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ec678617-6942-433b-80ee-2b331820f9b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b5ebb310-46d5-4bcd-b7f1-1f5b937cc5be"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8038a3ff-88e1-40e6-9668-d7f35ecbb7d8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("cbf56170-9798-4579-a418-7a3eaf337c25"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000000"),
		  .is_direct(0),
