...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Slave_v2_70"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Slave_v2_70\B_SPI_Slave_v2_70.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Slave_v2_70"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Slave_v2_70\B_SPI_Slave_v2_70.v"
`endif
...
module SPI_Slave_v2_70_3 (
	...
	cy_clock_v1_0
		#(.id("d93e9c45-54c2-47ca-9dae-2e4aa6dff2de/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__MotorPWM_1_BRUN_net;
	wire [0:0] tmpFB_0__MotorPWM_1_BRUN_net;
	wire [0:0] tmpIO_0__MotorPWM_1_BRUN_net;
	wire [0:0] tmpINTERRUPT_0__MotorPWM_1_BRUN_net;
	electrical [0:0] tmpSIOVREF__MotorPWM_1_BRUN_net;
	...
	cy_psoc3_pins_v1_10
		...
		MotorPWM_1_BRUN
		 (.oe(tmpOE__MotorPWM_1_BRUN_net),
		  .y({Net_1679}),
		  .fb({tmpFB_0__MotorPWM_1_BRUN_net[0:0]}),
		  .io({tmpIO_0__MotorPWM_1_BRUN_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorPWM_1_BRUN_net),
		  .interrupt({tmpINTERRUPT_0__MotorPWM_1_BRUN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorPWM_1_BRUN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Forward_ORANGE_net;
	wire [0:0] tmpFB_0__Forward_ORANGE_net;
	wire [0:0] tmpIO_0__Forward_ORANGE_net;
	wire [0:0] tmpINTERRUPT_0__Forward_ORANGE_net;
	electrical [0:0] tmpSIOVREF__Forward_ORANGE_net;

	cy_psoc3_pins_v1_10
		#(.id("73c256be-c7d2-4434-87ee-10d69c31bead"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Forward_ORANGE
		 (.oe(tmpOE__Forward_ORANGE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Forward_ORANGE_net[0:0]}),
		  .io({tmpIO_0__Forward_ORANGE_net[0:0]}),
		  .siovref(tmpSIOVREF__Forward_ORANGE_net),
		  .interrupt({tmpINTERRUPT_0__Forward_ORANGE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Forward_ORANGE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("886450d2-6b66-4a5a-9a81-ab4b7bdc8a14"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("064b1000-94a2-4ba3-84f5-62e2a4675bea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e12fac35-0af9-4264-ac12-08e03b1eb95b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("a6c70bac-5881-4adc-9772-5ba7045626a2"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	wire [0:0] tmpOE__MotorPWM_2_BLAA_net;
	wire [0:0] tmpFB_0__MotorPWM_2_BLAA_net;
	wire [0:0] tmpIO_0__MotorPWM_2_BLAA_net;
	wire [0:0] tmpINTERRUPT_0__MotorPWM_2_BLAA_net;
	electrical [0:0] tmpSIOVREF__MotorPWM_2_BLAA_net;

	cy_psoc3_pins_v1_10
		#(.id("53bcceca-66d4-4a54-866f-5d8ddaceadec"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorPWM_2_BLAA
		 (.oe(tmpOE__MotorPWM_2_BLAA_net),
		  .y({Net_1665}),
		  .fb({tmpFB_0__MotorPWM_2_BLAA_net[0:0]}),
		  .io({tmpIO_0__MotorPWM_2_BLAA_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorPWM_2_BLAA_net),
		  .interrupt({tmpINTERRUPT_0__MotorPWM_2_BLAA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorPWM_2_BLAA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PowerButton_net;
	wire [0:0] tmpIO_0__PowerButton_net;
	wire [0:0] tmpINTERRUPT_0__PowerButton_net;
	electrical [0:0] tmpSIOVREF__PowerButton_net;

	cy_psoc3_pins_v1_10
		#(.id("9306438a-5d99-423c-9048-b87ec8f3aaa5"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PowerButton
		 (.oe(tmpOE__PowerButton_net),
		  .y({1'b0}),
		  .fb({Net_2898}),
		  .io({tmpIO_0__PowerButton_net[0:0]}),
		  .siovref(tmpSIOVREF__PowerButton_net),
		  .interrupt({tmpINTERRUPT_0__PowerButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PowerButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__FollowButton_net;
	wire [0:0] tmpIO_0__FollowButton_net;
	wire [0:0] tmpINTERRUPT_0__FollowButton_net;
	electrical [0:0] tmpSIOVREF__FollowButton_net;

	cy_psoc3_pins_v1_10
		#(.id("1a8af388-53e3-4044-808f-02274fd72dbd"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		FollowButton
		 (.oe(tmpOE__FollowButton_net),
		  .y({1'b0}),
		  .fb({Net_2918}),
		  .io({tmpIO_0__FollowButton_net[0:0]}),
		  .siovref(tmpSIOVREF__FollowButton_net),
		  .interrupt({tmpINTERRUPT_0__FollowButton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FollowButton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_2 UART_1 (
        ...
        .reset(Net_1785),
        .rx(Net_1786),
        .tx_interrupt(Net_2932),
        .rx_interrupt(Net_2933),
        .tx_data(Net_2934),
        .tx_clk(Net_2935),
        .rx_data(Net_2936),
        .rx_clk(Net_2937));
	...
	cy_psoc3_pins_v1_10
		#(.id("ff5b6ce4-4ec8-4f67-b23e-0af8df059f0d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Backward_GUL_net;
	wire [0:0] tmpFB_0__Backward_GUL_net;
	wire [0:0] tmpIO_0__Backward_GUL_net;
	wire [0:0] tmpINTERRUPT_0__Backward_GUL_net;
	electrical [0:0] tmpSIOVREF__Backward_GUL_net;

	cy_psoc3_pins_v1_10
		#(.id("d1fc6837-6e7b-4b98-b266-63e725c44bb9"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Backward_GUL
		 (.oe(tmpOE__Backward_GUL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Backward_GUL_net[0:0]}),
		  .io({tmpIO_0__Backward_GUL_net[0:0]}),
		  .siovref(tmpSIOVREF__Backward_GUL_net),
		  .interrupt({tmpINTERRUPT_0__Backward_GUL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Backward_GUL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("3851e935-998d-4faa-b6a0-7a0ae0a5c03b"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    SPI_Slave_v2_70_3 SPIS (
        ...
        .miso(Net_30),
        .clock(1'b0),
        .tx_interrupt(Net_3044),
        .sdat(Net_3045),
        .rx_interrupt(Net_2925),
        .miso_oe(Net_3046),
        .reset(Net_2927));
	...
	cy_psoc3_pins_v1_10
		#(.id("f3ce0a91-e7e3-4cb3-b3f1-70113d7c1676"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("efcf4a14-08da-44b9-8420-c3462aef50e2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Slave_v2_70_6 SPIS_1 (
        .mosi(Net_3078),
        .sclk(Net_3079),
        .ss(Net_51),
        .miso(Net_3080),
        .clock(1'b0),
        .tx_interrupt(Net_3082),
        .sdat(Net_3083),
        .rx_interrupt(Net_52),
        .miso_oe(Net_3084),
        .reset(1'b0));
	...
	cy_psoc3_pins_v1_10
		#(.id("58c64aa7-65f5-4558-bffc-2e7050cf51c9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("04743ef4-6c7c-41fc-bd72-2d18a03f01de"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
