...
#define LED_PWM_UseOneCompareMode              (0u)
...
**************************************/
#define LED_PWM_INIT_PERIOD_VALUE          (100u)
#define LED_PWM_INIT_COMPARE_VALUE1        (0u)
#define LED_PWM_INIT_COMPARE_VALUE2        (0u)
